...
//localStorage.setItem("woodblvl",0);
//localStorage.setItem("stoneblvl",0);
...
function Update_resources() {
  ...
  $(".nextlvlfood").html(
    "Aktualny lvl: " +
      ...
      "</br>" +
      "Wood: " +
      pricelvlFood[foodbLvl][0] +
      " " +
      "Stone: " +
      pricelvlFood[foodbLvl][1]
  );
  $(".nextlvlwood").html(
    "Aktualny lvl: " +
      woodbLvl +
      "</br>" +
      "Wood: " +
      pricelvlWood[woodbLvl][0] +
      " " +
      "Stone: " +
      pricelvlWood[woodbLvl][1]
  );
  $(".nextlvlstone").html(
    "Aktualny lvl: " +
      stonebLvl +
      "</br>" +
      "Wood: " +
      pricelvlStone[stonebLvl][0] +
      " " +
      "Stone: " +
      pricelvlStone[stonebLvl][1]
  );
  ...
  if (
    pricelvlStone[stonebLvl][0] < wood &&
    pricelvlStone[stonebLvl][1] < stone
  ) {
